...
function Content() {
            ...
            return (
                <div className="min-w-full min-h-full flex items-center justify-center">
                    <button disabled type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
                        ...
                        PLEASE WAIT WHILE OUR AI ANALYZING 
                    </button>
                </div>
            )
        }else{
    ...
    return (
        <>
            <div className="min-h-[70vh]  p-6 text-slate-950">
                <div className="min-h-[70vh] w-full bg-slate-50 rounded-xl p-2">
                    {getInsightsSCreen()}

                </div>
                <div className="my-3">
                    <form action={handleSubmit} className="flex gap-2 justify-center p-3">
                        <select 
                        name="post-type"
